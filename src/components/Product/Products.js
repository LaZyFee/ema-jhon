    ...
    return (
        <div className="card  bg-slate-100 shadow-xl">
            ...
            <div className="card-body">
                <h2 className="card-title text-2xl text-[#0E161A]">{name}</h2>
                <h6 className='text-xl text-[#0E161A]'>Price: ${price}</h6>
                <div>
            ...
            <button onClick={() => handleAddToCart(product)} className="btn w-full bg-[#FFE0B3] hover:bg-info text-[#95A0A7] hover:text-black">Add to Cart <svg xmlns="http://www.w3.org/2000/svg" width="23" height="24" viewBox="0 0 23 24" fill="none">
